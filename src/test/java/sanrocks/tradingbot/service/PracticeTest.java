...
public class PracticeTest {
    ...
    public void setup() {
        ...
        restaurantDbTemplate =
                new MongoTemplate(MongoClients.create(mongoClientSettings), "restaurantdb");
         ...
         *
         * <p>esTemplate = new
         * ElasticsearchRestTemplate(RestClients.create(clientConfiguration).rest());
         */
    }
