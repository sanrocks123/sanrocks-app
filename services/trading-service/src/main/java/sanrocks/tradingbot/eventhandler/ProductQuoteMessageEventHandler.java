...
public class ProductQuoteMessageEventHandler {
    ...
    @Autowired private ProductPriceUpdateEventHandler priceUpdateEventHandler;

    @Autowired private ProductQuoteEventReactiveRepository productQuoteEventRepository;
